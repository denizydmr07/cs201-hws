...
int main() {
    ...
    // LMS.addTeam("Fener", 1907);
    // LMS.addTeam("BJK", 1903);
    // LMS.addTeam("Fener", 1907);
    // LMS.removeTeam("Fener");
    // LMS.addTeam("Fener", 1907);
    // LMS.removeTeam("Orhan");
    // LMS.removeTeam("Fener");
    // LMS.removeTeam("Fener");

    // LMS.addPlayer("Fener", "Melih Mahmutoglu", 10, 200000);
    // LMS.addPlayer("BJK", "Melih Mahmutoglu", 10, 200000);
    // LMS.addTeam("Fener", 1907);

    // LMS.transferPlayer("Melih Mahmutoglu", "Lakers", "Fener");
    // LMS.transferPlayer("Deniz Aydemir", "BJK", "Fener");
    // LMS.transferPlayer("Melih Mahmutoglu", "BJK", "Fener");
    LMS.showAllTeams();
    cout << endl;
